                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <div>
                                <form action="AdminController" method="POST">
                                    <button class="btn btn-primary mb-3">Crear Votación</button><br>
                                    <input type="hidden" name="pagina" value="votacion"><!-- comment -->
    ...
    <div class="container mt-4">
        ...
        <div class="row text-center py-3">
            <div class="col-lg-6 m-auto">
                <h1 class="h1">Listado de Votaciones</h1>
            </div>
        </div>
        <div class="row mt-4">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <c:forEach var="votacion" items="${votingList}" varStatus="status">
                                    <tr>
                                        <td>${votacion.titulo}</td>
                                        <td>${votacion.fechaLimite}</td>
                                        <td>
                                            <div class="mt-3">
                                                <form action="AdminController" method="POST">
                                                    <input type="hidden" name="action" value="eliminar">
                                                    <input type="hidden" name="idVotacion" value="${votacion.nid}">
                                                    <button type = "submit" name="pagina" value="votacion" class="btn btn-danger">Eliminar</button>
                                                </form>
