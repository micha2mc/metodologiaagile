                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <div>
                                <form action="AdminController" method="POST">
                                    <button href="#" class="btn btn-primary mb-3">Crear Circuito</button><br>
                                    <input type="hidden" name="pagina" value="circuito">
                ...
                <div class="col-md-3 mb-3">
                    <div class="card product-card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="AdminController?pagina=circuito&circuito=${circuito.nid}&action=update&tipo=add&idusuarioconectado=${usuarioConectado.nid}"class="btn btn-success">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                                <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
                                <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
                                </svg>
                            </a>
                            <a href="AdminController?pagina=circuito&circuito=${circuito.nid}&action=update&idusuarioconectado=${usuarioConectado.nid}" class="btn btn-warning">
                            ...
                            <c:if test="${!circuito.calendar}">
                                <a href="AdminController?pagina=circuito&circuito=${circuito.nid}&action=delete&idusuarioconectado=${usuarioConectado.nid}" class="btn btn-danger">
