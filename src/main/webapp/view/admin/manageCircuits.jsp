                    ...
                    <nav class="navbar navbar-expand-lg">
                        <div class="collpse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a style="margin-left: 10px; border: none" class="btn btn-outline-ligth" href="view/admin/circuitForm.jsp">Crear Circuito</a>
                                </li>
                            </ul>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <c:if test="${!circuito.calendar}">
                                            <a href="detalleCircuito.jsp?id=${circuito.nid}" class="btn btn-danger">
